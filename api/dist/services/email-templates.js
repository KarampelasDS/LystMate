...
exports.resetPasswordEmail = exports.emailChangeAlertEmail = exports.verifyEmailEmail = exports.welcomeEmail = void 0;
...
const button = (href, label) => `<a href="${href}" style="display:inline-block;background:#2c1810;color:#fff8f0;text-decoration:none;font-size:14px;font-weight:500;padding:12px 28px;border-radius:12px;margin-top:8px;">${label}</a>`;
const heading = (text) => `<h1 style="margin:0 0 12px;font-size:22px;font-family:Georgia,serif;color:#2c1810;font-weight:normal;">${text}</h1>`;
const para = (text) => `<p style="margin:0 0 20px;font-size:14px;line-height:1.6;color:#4a2c1a;">${text}</p>`;
const muted = (text) => `<p style="margin:24px 0 0;font-size:12px;color:#9b7d6a;line-height:1.5;">${text}</p>`;
const welcomeEmail = (name, token) => layout(`
...
const verifyEmailEmail = (token) => layout(`
...
const emailChangeAlertEmail = (newEmail) => layout(`
  ...
  `);
exports.emailChangeAlertEmail = emailChangeAlertEmail;
const resetPasswordEmail = (token) => layout(`
